...
void AxisRealignedBoundingBox::Init(void)
{
	m_fRadius = 0.0f;
...
void AxisRealignedBoundingBox::Swap(AxisRealignedBoundingBox& other)
{
...
void AxisRealignedBoundingBox::Release(void)
{

}
//The big 3
AxisRealignedBoundingBox::AxisRealignedBoundingBox(std::vector<vector3> a_lVectorList)
{
...
AxisRealignedBoundingBox::AxisRealignedBoundingBox(AxisRealignedBoundingBox const& other)
{
...
AxisRealignedBoundingBox& AxisRealignedBoundingBox::operator=(AxisRealignedBoundingBox const& other)
{
	if (this != &other)
	{
		Release();
		Init();
		AxisRealignedBoundingBox temp(other);
		Swap(temp);
	}
	return *this;
}
AxisRealignedBoundingBox::~AxisRealignedBoundingBox() { Release(); };
//Accessors
void AxisRealignedBoundingBox::SetModelMatrix(matrix4 a_m4ToWorld) { m_m4ToWorld = a_m4ToWorld; }
vector3 AxisRealignedBoundingBox::GetCenterG(void) { return vector3(m_m4ToWorld * vector4(m_v3Center, 1.0f)); }
float AxisRealignedBoundingBox::GetRadius(void) { return m_fRadius; }
vector3 AxisRealignedBoundingBox::GetSize(void) { return m_v3Size; };
//--- Non Standard Singleton Methods
bool AxisRealignedBoundingBox::IsColliding(AxisRealignedBoundingBox* const a_pOther)
{
...
matrix4 AxisRealignedBoundingBox::GetModelMatrix(void) { return m_m4ToWorld; }